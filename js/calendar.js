...
//     //Buiding each day button
//     for (let day = 1; day <= dayInMonth; day++) {
//         const dayButton = document.createElement("button");
//         dayButton.textContent = day;
//         dayButton.classList = "calendar-day";
//         const dateKey = formatDateKey(currentYear, currentMonth, day);
...
//         const bookedForDay = bookedAppointments[selectedDate.key] || [];
//         if (slots.length === 0) {
//             timeSlots.innerHTML = `<p class="selected-date-text">No appointments available fpr this date.</p>`;
//             return;
//         }
//         for (let i = 0; i < slots.length; i++) {
//             const slot = slots[i];
...
//             slotBtn.className = "time-slot-btn";
//             if (bookedForDay.includes(slot)) {
//                 slotBtn.classListadd.add("disabled");
//                 slotBtn.disabled = true;
//                 slotBtn.textContent = `${slot} - Booked`;
//             }
//             if (selectedTime === slot) {
...
//             selectedDate.day,
//         )} at ${timeValue}.`;
//         bookingMessage.className = "booking-message succes";
//         bookingForm.reset();
//         selectedTime = "";
//         selectedTimeInput.value = "";
//         renderTimeSlots();
